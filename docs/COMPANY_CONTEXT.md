...
> **v1.1:** 副社長AI 🅸 神崎 VP を追加。外部相談役 ChatGPT副社長を明文化。
...
**🌐 ChatGPT副社長（External Advisor）**
- 立場: 社外の相談役。AI_WORKERの社員ではない（指揮系統の外）
- 役割: 新規事業相談・外部視点レビュー・「売れるか/必要か/タイミング」確認・AI_WORKER自体の進化相談
- 目的: 内部AIだけだと会社文化に寄りすぎるため、外部視点で判断品質を保つ
- 連携: `#副社長室` チャンネル経由でCEOが相談結果を社内へ橋渡し（詳細: `docs/vp-room-operations.md`）
- **禁止: 社内タスクの直接指示 / 承認 / 社内データへの直接アクセス**

> 大方針フロー: 社長 → ChatGPT外部相談 → 神崎VPへ方針共有 → AI_WORKER実行
